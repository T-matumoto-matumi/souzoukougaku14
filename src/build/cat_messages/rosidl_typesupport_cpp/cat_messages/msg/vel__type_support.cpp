...
static const _Vel_type_support_symbol_names_t _Vel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cat_messages, msg, Vel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cat_messages, msg, Vel)),
  }
};
...
get_message_type_support_handle<cat_messages::msg::Vel>()
{
  return &::cat_messages::msg::rosidl_typesupport_cpp::Vel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cat_messages, msg, Vel)() {
  return get_message_type_support_handle<cat_messages::msg::Vel>();
}
