...
#include "cat_messages/msg/detail/vel__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cat_messages::msg::Vel;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cat_messages::msg::Vel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cat_messages::msg::Vel *>(
    untyped_ros_message);
...
{
  return &cat_messages::msg::typesupport_fastrtps_cpp::_Vel__handle;
}
