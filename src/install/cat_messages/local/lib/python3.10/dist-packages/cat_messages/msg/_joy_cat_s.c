...
bool cat_messages__msg__joy_cat__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cat_messages.msg._joy_cat.JoyCat", full_classname_dest, 32) == 0);
  }
  cat_messages__msg__JoyCat * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of JoyCat */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cat_messages.msg._joy_cat");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JoyCat");
