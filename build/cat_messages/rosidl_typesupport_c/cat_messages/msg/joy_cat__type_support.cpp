...
static const _JoyCat_type_support_symbol_names_t _JoyCat_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cat_messages, msg, JoyCat)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cat_messages, msg, JoyCat)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cat_messages, msg, JoyCat)() {
  return &::cat_messages::msg::rosidl_typesupport_c::JoyCat_message_type_support_handle;
}
